...
SCENE_FILE = join(dirname(abspath(__file__)), 'Scenes/scene_NAO_SAC_envV1.8.2.2.ttt')
...
class NAOBallEnv(gym.Env):
    ...
    def make_observation(self):
        ...
        if  self.ball_z > +0.82 and self.ball_z < +1.14 and self.ball_time_caught > 0:
    ...
    def reset(self):
        ...
        if self.pr.running:
            ...
            sim.simSetStringSignal('videoPath', self.directory + '/rec/touch{}'.format(self.epochN))
