...
#scene_path_windows = r"C:\Users\renan-note\Documents\VrepNAOSac\Scenes\CenarioV1.3.6.5.ttt"
scene_path = "/home/nanbaima/Documents/naovrepenv/Scenes/CenarioV1.3.6.5.ttt"
#scene_path_neuron0 = "/home/renan/naovrepenv/Scenes/CenarioV1.3.6.5.ttt"
...
class NAOBallEnv(vrep_env.VrepEnv):
    def __init__(self):
        ...
        #self.makeobservation = [ joint_names, col_names]
    ...
    def reset(self):
        ...
        self.obj_set_position(self.ball_handle, 
		    [random.uniform(-0.587, -0.437),
		     random.uniform(0.39, 0.565), 0.40874]
		      )

        self.start_simulation()

        print("Last episode n " + 
    ...
    def make_observation(self):
        """
        Observing every element that we want to take in consideration during the observation
        traning phase.
        """
        observation  = []
        ...
        if the objective has been reached, moving the ball
        """
        ...
        for col_handle in self.col_handles:
            ...
            It is trying to read if eather side of the robot's manipulator has reached and grabed the
            object.
            """
            if n_handle < len(self.col_handles)//2:
                if self.read_collision(col_handle):
...
#        observation.append(self.Rtouch)
    ...
    def step(self, action):
        ...
        if self.Ltouch or self.Rtouch:
#        if self.Rtouch:
            reward += 100
        elif self.RfingerSensors3 > 0 or self.LfingerSensors3 > 0:
#        elif self.RfingerSensors3 > 0:
            reward += 1
        else:
            reward -= 1
        ...
        done = (self.ball_z < +2.8608e-1) or self.Rtouch or self.Ltouch
...
if __name__ == "__main__":
    ...
    while True:
        env.reset()
        for _ in range(1000):
#            o = env.step(13*[random.uniform(-6.4, 6.4)])
            o = env.step(26*[random.uniform(-6.4, 6.4)])
